    ...
    <main>
      <div class="header">
        <div>
          ...
          <p>Runtime dashboard for service health, usage, cache, provider state, and source registry.</p>
        </div>
      </div>
...
const isPublicInstallInfoPath = (pathName) =>
  pathName === '/'
  || pathName === '/configure'
  || pathName === '/donate'
  || pathName === '/providers'
...
const isBotProtectionIgnoredPath = (pathName) =>
  pathName === '/health'
  || isPublicInstallInfoPath(pathName)
