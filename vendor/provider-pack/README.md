# Provider Pack - Compiled by =[D3adly]=

A reusable collection of local provider scrapers and helper modules.

## Installation

1. Open your host application
2. Go to the local provider settings
3. Add this repository URL:
   ```
   https://raw.githubusercontent.com/D3adlyRocket/provider-pack/refs/heads/main/manifest.json
   ```
